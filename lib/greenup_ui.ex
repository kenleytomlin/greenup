defmodule GreenupUi do
  ...
  ### Server-Client Communication
      ...
      def handle_event("open_dialog", _params, socket) do
        socket = GreenupUi.LiveView.send_command(socket, "user-dialog", "open")
        {:noreply, socket}
      end
  ...
  defmacro __using__(_) do
    quote do
      import GreenupUi.Accordion
      import GreenupUi.Alert
      import GreenupUi.AlertDialog
      import GreenupUi.Avatar
      import GreenupUi.Badge
      import GreenupUi.Breadcrumb
      import GreenupUi.Button
      import GreenupUi.Card
      import GreenupUi.Chart
      import GreenupUi.Checkbox
      import GreenupUi.Collapsible
      import GreenupUi.Dialog
      import GreenupUi.DropdownMenu
      import GreenupUi.Form
      import GreenupUi.Helpers
      import GreenupUi.HoverCard
      import GreenupUi.Icon
      import GreenupUi.Input
      import GreenupUi.Label
      import GreenupUi.Menu
      import GreenupUi.Pagination
      import GreenupUi.Popover
      import GreenupUi.Progress
      import GreenupUi.RadioGroup
      import GreenupUi.ScrollArea
      import GreenupUi.Select
      import GreenupUi.Separator
      import GreenupUi.Sheet
      import GreenupUi.Sidebar
      import GreenupUi.Skeleton
      import GreenupUi.Slider
      import GreenupUi.Switch
      import GreenupUi.Table
      import GreenupUi.Tabs
      import GreenupUi.Textarea
      import GreenupUi.Toggle
      import GreenupUi.ToggleGroup
      import GreenupUi.Tooltip
    end
  end
end
